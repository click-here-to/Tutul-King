...
def rmenu1():
	...
	with ThreadPool(max_workers=60) as tonxoys:
		...
		for rngx in xode:
			...
			if "2" in rcd:psd=[id,rngx,id[5:],"Bangladesh','bangladesh','Bangla','bangla','I LOVE YOU','i love you','@@@###','@#@#@#','###@@@','১২৩৪৫৬৭৮','sadiya','sumaiya','jannatul','00998877','113355','mababa','১২৩৪৫৬৭','sabbir','aabbcc','abbuammu','sumiya','১২৩৪৫৬৭৮৯','123456','1234567','12345678','123456789"]
